...
public class BleScanner {
    ...
    public void scan(UUID[] serviceUuid, long timeOut, final BleScanCallback callback) {

        startLeScan(serviceUuid, timeOut, callback);
    }


    private synchronized void startLeScan(UUID[] serviceUuid, long timeOut, BleScanPresenterImp imp) {
        ...
        boolean success = BleManager.getInstance().getBluetoothAdapter()
                .startLeScan(serviceUuid, mBleScanPresenter);
