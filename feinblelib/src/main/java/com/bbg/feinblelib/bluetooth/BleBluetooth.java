...
public class BleBluetooth {
    ...
    public synchronized BluetoothGatt connect(BleDevice bleDevice,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            bluetoothGatt = bleDevice.getDevice().connectGatt(BleManager.getInstance().getContext(),false, coreGattCallback, TRANSPORT_LE);
        } else {
            bluetoothGatt = bleDevice.getDevice().connectGatt(BleManager.getInstance().getContext(),false, coreGattCallback);
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case BleMsg.MSG_RECONNECT: {
                    connect(bleDevice, bleGattCallback, connectRetryCount);
                }
                break;
